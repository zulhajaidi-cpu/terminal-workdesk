...
export function KpiContent({ kpiItems, viewableUsers, month, year, targetUserId, currentUser, totalWeight, totalFinal, canViewOthers }: Props) {
    ...
    <div className="max-w-6xl mx-auto animate-fade-in space-y-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {/* User picker (untuk manager/admin) */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          { label: 'Total KPI', value: kpiItems.length, unit: 'item' },
          { label: 'Total Bobot', value: `${totalWeightPct}%`, unit: '', warn: !weightOk && kpiItems.length > 0 },
